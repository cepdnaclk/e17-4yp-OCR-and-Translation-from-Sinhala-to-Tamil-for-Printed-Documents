...
___
"The goal of this project is to develop a software application that can recognize printed text in Sinhala language, convert it to editable text, and then translate it to Tamil language. The application will utilize optical character recognition (OCR) technology to convert printed documents of Sinhala text into digital text, and then use machine translation algorithms to translate the Sinhala text into Tamil language.
